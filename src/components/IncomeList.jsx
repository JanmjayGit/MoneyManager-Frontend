    ...
    return (
        <div className='card bg-gray-900 text-gray-200 rounded-xl border border-gray-700 p-6'>
            <div className='flex items-center justify-between'>
                <h5 className='text-lg font-medium text-white'>Income Sources</h5>
                <div className='flex items-center justify-end gap-4'>
                    <button
                        onClick={handleEmail}
                        disabled={loading}
                        className='flex items-center gap-2 cursor-pointer bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-2 rounded-lg transition-colors'>
                        {loading ? (
                            <>
