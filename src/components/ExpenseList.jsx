            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center justify-end gap-4'>
                    <button
                        onClick={handleEmail}
                        disabled={loading}
                        className='flex items-center gap-2 cursor-pointer bg-emerald-500 hover:bg-emerald-600 px-3 py-2 rounded-lg text-white transition-colors'>
                        {loading ? (
                            <>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className='flex items-center gap-2 cursor-pointer text-white bg-emerald-500 hover:bg-emerald-600 px-3 py-2 rounded-lg transition-colors'>
                        {loading ? (
                            <>
                                <LoaderCircle className='h-4 w-4 animate-spin' />
                                Downloading...
