...
const Contact = () => {
  ...
  const WEB3FORMS_ACCESS_KEY = "677d7ebb-93ba-41a0-a325-3cd3dd7bf6ff" // Replace with your actual key
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold bg-gradient-to-br from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">Get in Touch</h1>
