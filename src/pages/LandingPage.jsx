...
import { BarChart3, Shield, PieChart, TrendingUp, TrendingDown, CheckCircle, ArrowRight, User, Menu, X } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300"
            >
              Start Tracking for Free
            </button>
            <button
              onClick={() => handleNavigation('/about')}
              className="bg-gray-800 border-2 border-emerald-500 text-emerald-500 px-8 py-4 rounded-lg text-lg font-semibold transition-colors duration-200 flex items-center justify-center gap-2"
            >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">See Your Finances at a Glance</h2>
            <p className="text-xl text-gray-300">Powerful dashboard with everything you need</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-2xl p-8 shadow-lg">
            <div className="bg-slate-900 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-emerald-500 font-semibold">MoneyManager</span>
                </div>
              ...
              <div className="bg-gray-900 p-6 rounded-xl shadow-md border border-gray-700">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">₹1,85,000</p>
                  </div>
                </div>
              </div>
              <div className="bg-gray-900 p-6 rounded-xl shadow-md border border-gray-700">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">₹1,00,800</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">10th Jul 2025</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-white">Uber</p>
                        <p className="text-sm text-gray-300">12th Jul 2025</p>
                      </div>
                    </div>
              ...
              <div className="bg-gray-900 p-6 rounded-xl shadow-md border border-gray-700">
                ...
                <div className="w-32 h-32 mx-auto bg-emerald-600 rounded-full flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-900 rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300 border border-gray-700">
                <div className="w-16 h-16 bg-emerald-600 rounded-xl flex items-center justify-center mx-auto mb-4 text-white">
                  {feature.icon}
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={() => handleNavigation('/signup')}
            className="bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-4 rounded-lg text-lg font-semibold transition-all duration-300"
          >
            Get Started Now
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-xl font-bold text-emerald-500">MoneyManager</span>
              </div>
              <p className="text-gray-400 mb-4">
                Simplifying personal finance management for everyone.

              </p>
              <p className='text-gray-400 -mt-4'>Take control of your financial future today.</p>
            </div>
            <div>
